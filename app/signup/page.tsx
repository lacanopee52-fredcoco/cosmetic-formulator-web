...
export default function SignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (/already registered|already exists|déjà utilisé|email.*taken/i.test(msg)) {
        setError('Cet email est déjà utilisé. Connectez-vous avec votre mot de passe ou utilisez un autre email.')
      } else {
        setError(msg)
      }
    } finally {
